...
class CreateAttendeeWizard(models.TransientModel):
    ...
    session_ids = fields.Many2many(comodel_name="academic.session", string="Sessions",default=_get_default_session )
    ...
    def action_add_attendee(self):
        ...
        #att_data =[{'partner-id' :1}, {'partner-id' :2} ,{'partner-id' :3}]
